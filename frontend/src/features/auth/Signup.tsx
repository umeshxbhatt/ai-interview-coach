...
import { User, Mail, KeyRound, AlertTriangle, ArrowRight, CheckCircle2 } from 'lucide-react';
...
export default function Signup() {
  ...
  const rules = [
    ...
    { label: 'One uppercase letter', valid: /[A-Z]/.test(passwordVal) },
    { label: 'One lowercase letter', valid: /[a-z]/.test(passwordVal) },
    { label: 'One digit [0-9]', valid: /[0-9]/.test(passwordVal) },
  ];
      ...
      >
        ...
        <div className="text-center mb-8">
          ...
          <p className="mt-2 text-sm text-zinc-400">
            ...
            <Link to="/login" className="text-purple-400 hover:text-purple-300 font-medium transition-colors" onClick={clearError}>
              Sign in
            </Link>
          </p>
        </div>
          ...
          {isSuccess ? (
            ...
            >
              ...
              <p className="text-zinc-400 text-sm max-w-xs mx-auto">
                Your account was created successfully. Redirecting you to the sign-in screen...
              </p>
            </motion.div>
          ) : (
            <>
